 ...
 * @author PC
 */
public class BANGANH extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("GBP TO OTHER");

        txtGBP.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtGBP.setText("Bảng Anh (GBP)");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addGap(86, 86, 86)
                            .addComponent(txtGBP, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(20, 20, 20)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(btnVND, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnJPYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJPYActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " GBP" + 
                                " = " + 
                                String.valueOf(Math.round((calulator*154.00)*100.0)/100.0) + " JPY") ;
    ...
    private void btnUSDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUSDActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " GBP" + 
                                " = " + 
                                String.valueOf(Math.round((calulator*1.3055)*100.0)/100.0) + " USD") ;
            btnAgain.setVisible(true);
            txtDes.setVisible(true);
        }
    ...
    private void btnEURActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEURActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " GBP" + 
                                " = " + 
                                String.valueOf(Math.round((calulator*1.1904)*100.0)/100.0) + " EUR") ;
            btnAgain.setVisible(true);
            txtDes.setVisible(true);
        }
    ...
    private void btnVNDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVNDActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " GBP" + 
                                " = " + 
                                String.valueOf(Math.round((calulator*29908.48)*100.0)/100.0) + " GBP") ;
            btnAgain.setVisible(true);
            txtDes.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BANGANH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel txtGBP;
