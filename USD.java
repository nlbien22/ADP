...
public class USD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(656, 330));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addGap(86, 86, 86)
                            .addComponent(txtUSD, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(20, 20, 20)
    ...
    private void btnJPYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJPYActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " USD" +
                " = " +
                String.valueOf(Math.round((calulator*117.95)*100.0)/100.0) + " JPY") ;
    ...
    private void btnVNDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVNDActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " USD" +
                " = " +
                String.valueOf(Math.round((calulator*22894.04)*100.0)/100.0) + " VND") ;
            btnAgain.setVisible(true);
            txtDes.setVisible(true);
        }
    ...
    private void btnEURActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEURActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " USD" +
                " = " +
                String.valueOf(Math.round((calulator*0.91118)*100.0)/100.0) + " EUR") ;
            btnAgain.setVisible(true);
            txtDes.setVisible(true);
        }
    ...
    private void btnGBPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGBPActionPerformed
        ...
        if(edtInput.getText().length() < 1) {
            ...
            txtResult.setText(edtInput.getText() + " USD" +
                " = " +
                String.valueOf(Math.round((calulator*0.76725)*100.0)/100.0) + " GBP") ;
            btnAgain.setVisible(true);
            txtDes.setVisible(true);
        }
